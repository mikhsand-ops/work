...
try: 
# Write to CSV
    csv_file_name = f'dumpTest-{date}.csv'
    csv_file_path = '../data/'
    path = os.path.join(csv_file_path,csv_file_name)
    ...
    logger.debug(f"success writing csv ")
except:
    logger.error("error writing csv" + traceback.format_exc())